...
PIPELINE_JS = {
    ...
    'js-tests': {
        'source_filenames': (
            ...
            'rb/js/models/tests/fileDiffModelTests.js',
            ...
            'rb/js/models/tests/reviewModelTests.js',
            'rb/js/models/tests/reviewReplyEditorModelTests.js',
            'rb/js/models/tests/reviewReplyModelTests.js',
    ...
    'reviews': {
        'source_filenames': (
            ...
            'rb/js/models/reviewReplyModel.js',
